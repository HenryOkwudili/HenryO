...
int main()
{
	...
	ptr = &ptr1;
		...
		cout<<"Address Value of single ponter ptr2 = "<<ptr2<<endl;
		cout<<"Content value of double ponter ptr1 = "<<**ptr1<<endl;
		cout<<"Address Value of double pointer ptr1 = "<<ptr1<<endl;
		cout<<"Content of value of triple pointer ptr = "<<***ptr<<endl;
		cout<<"Address value of triple pointer ptr = "<<ptr<<endl;
